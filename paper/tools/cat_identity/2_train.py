...
執行環境：需要 torch / torchvision（CUDA 版）。本機請用專案的 conda 環境：
    C:\\Users\\homec\\anaconda3\\envs\\yolo_new\\python.exe 2_train.py
...
DATASET_PATH = r"C:\ai_project\paper\tools\train_data\cat_identity\dataset\crops"
...
if _MISSING:
    ...
    print(r'   & "C:\Users\homec\anaconda3\envs\yolo_new\python.exe" 2_train.py')
    print("   或安裝（CUDA 12.1）：")
